    ...
    <div className="w-[260px] h-full bg-[#e7e5e5] border-r border-gray-800 flex flex-col">
      ...
      <div className="p-3 border-b border-gray-800 bg-[#3c3c3c]">
        ...
        <div className="flex gap-2 mt-3">
          <button
            onClick={bulkDismiss}
            className="flex-1 bg-admin-accent-dark hover:bg-admin-accent-dark text-white text-xs py-1 rounded"
          >
            Bulk Dismiss
          </button>
        ...
        {teams.map(team => (
          <div
            ...
            className={`p-3 rounded-lg cursor-pointer border transition
              ${activeTeam === team.id
                ? "bg-admin-surface-raised text-white shadow-[0_0_18px_rgba(59,130,246,0.9)] ring-1 ring-admin-accent/40"
                : "bg-admin-surface-raised hover:bg-admin-surface-raised text-white/80"
              }`}
          >
