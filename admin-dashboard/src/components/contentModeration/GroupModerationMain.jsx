...
export default function GroupModerationMain({ selectedTeam }) {
  ...
  return (
    <>
      <main className="bg-admin-bg border border-admin-border rounded-xl p-4 md:p-6 space-y-6 text-white">

        {/* HEADER */}
        <div className="flex gap-4 p-5 rounded-xl bg-gradient-to-r from-indigo-600/40 to-purple-600/30">
          <div className="w-14 h-14 rounded-lg bg-admin-accent-dark flex items-center justify-center">
            <Users size={26} />
          </div>
  ...
  <span className="flex items-center gap-1">
    <MapPin size={12} className="text-admin-accent" />
    California, USA
  </span>
</p>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            ...
            <button
              ...
              className="h-24 rounded-lg border border-dashed border-admin-accent/40 flex items-center justify-center text-admin-accent"
            >
              <Plus />
            </button>
          </div>
      ...
      {showUpload && (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
          <div
            ...
            className="bg-admin-bg p-5 rounded-xl w-[90%] max-w-sm"
          >
            ...
            <div
              ...
              className="h-32 border border-dashed border-admin-accent/40 rounded-lg flex items-center justify-center cursor-pointer"
            >
              <Upload />
            </div>
...
const Stat = ({ icon, label, value, color }) => {
  ...
  return (
    <div className="bg-admin-surface-raised border border-admin-border rounded-xl p-4">
...
const Activity = ({ icon, text, time, color, progress }) => {
  ...
  return (
    <div className="px-4 py-2 rounded-lg bg-admin-surface-raised border border-admin-border flex items-center gap-3">
      {/* Icon + Text */}
      <div className={`flex gap-2 items-center ${colors[color]}`}>
        {icon}
