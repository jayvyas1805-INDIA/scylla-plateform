...
export default function PaymentChart({ paymentStats }) {
  ...
  return (
  <div className="relative rounded-xl p-[2px] bg-gradient-to-r from-admin-accent to-admin-accent-dark shadow-[0_0_12px_rgba(0,255,255,0.4)]">
    <div className="bg-admin-bg rounded-[0.95rem] p-4 sm:p-6">
          ...
          {["Monthly", "Quarterly", "Yearly"].map((r) => (
            <button
              ...
              className={`px-3 py-1 rounded-lg text-xs font-medium transition-all ${
                range === r
                  ? "bg-admin-accent-dark text-white"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4 mb-6">
        {/* Collected */}
        <div className="bg-admin-surface-raised border border-green-500/30 rounded-xl p-3 sm:p-4">
        ...
        {/* Pending */}
        <div className="bg-admin-surface-raised border border-yellow-500/30 rounded-xl p-3 sm:p-4">
        ...
        {/* Refunded */}
        <div className="bg-admin-surface-raised border border-red-500/30 rounded-xl p-3 sm:p-4">
      ...
      <div className="mt-4 flex flex-col sm:flex-row sm:justify-end">
        <div className="w-full sm:w-fit bg-admin-surface-raised border border-admin-accent/30 rounded-md px-3 py-2">
          <h3 className="text-xs font-semibold text-admin-accent mb-1">
            Key Insights
          </h3>
