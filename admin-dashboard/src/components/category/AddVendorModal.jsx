...
export default function AddVendorModal({ initialData, onClose, onSave }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/70 flex items-center justify-center">
      <div
        className="bg-admin-surface border border-white/10 rounded-xl w-full max-w-md
      ...
      >
        ...
        <div className="flex justify-end gap-3 px-5 py-4 border-t border-white/10">
          ...
          <button
            ...
            className="px-4 py-2 rounded text-xs text-admin-accent
            bg-admin-accent/10 border border-admin-accent/40
            hover:bg-admin-accent/20 shadow-[0_0_12px_rgba(0,191,255,0.35)]"
          >
            Save
          </button>
        </div>
