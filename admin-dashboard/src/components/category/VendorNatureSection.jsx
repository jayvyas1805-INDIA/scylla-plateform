...
export default function VendorNatureSection() {
  ...
  return (
    <section className="bg-admin-surface border border-white/10 rounded-xl shadow-[0_0_25px_rgba(0,0,0,0.6)]">
      {/* HEADER */}
          ...
          return (
            <div
              ...
              className={`rounded-lg p-4 border border-white/10 transition shadow-md ${
                item.status ? "bg-admin-surface-raised" : "bg-admin-surface-raised opacity-60"
              }`}
            >
              ...
              <p className="text-xs text-admin-accent font-semibold">
