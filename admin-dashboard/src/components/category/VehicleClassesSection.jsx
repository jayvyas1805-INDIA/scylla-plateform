...
export default function VehicleClasses() {
  ...
  return (
    <div className="p-6 bg-gradient-to-b from-admin-bg to-admin-bg rounded-xl border border-white/5 text-white">
          ...
          <tbody className="divide-y divide-white/5">
            {visibleRows.map(r => (
              <tr key={r.id} className="hover:bg-white/5">
                ...
                <td className="p-2 flex items-center gap-2 text-admin-accent font-medium">
                ...
                <td className="p-2 text-center text-admin-accent">{r.teams}</td>
                <td className="p-2 text-center text-admin-accent">{r.events}</td>
                ...
                <td className="p-2">
                  <div className="flex justify-center gap-3">
                    ...
                    <button onClick={() => { setDrawer("edit"); setForm(r); }} className="text-admin-accent">
                      <Pencil size={14}/>
                    </button>
...
<div className="mt-10 p-5 rounded-xl border border-white/5 bg-gradient-to-br from-admin-bg to-admin-bg">
  ...
  <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
    {rows.map(r => (
      <div
        key={r.id}
        className="p-4 bg-admin-bg border border-white/10 rounded-xl hover:shadow-[0_0_10px_#22d3ee30] transition-shadow"
      >
        {/* Title */}
        <h4 className="text-admin-accent font-semibold mb-2">{r.name}</h4>
      ...
      {confirm && (
        <div className="fixed inset-0 bg-black/60 grid place-items-center z-50">
          <div className="bg-admin-bg p-6 rounded-xl border border-white/10 w-[320px]">
      ...
      {addOpen && (
        <div className="fixed inset-0 bg-black/60 grid place-items-center z-50">
          <div className="w-[340px] bg-admin-bg border border-white/10 rounded-xl p-5">
