    ...
    <header className="mb-6">
      ...
      <div className="flex flex-wrap gap-4 mt-4">
        <input
          type="text"
          placeholder="Search..."
          className="bg-admin-surface-raised text-white px-4 py-2 rounded-md w-full sm:w-1/2"
          value={search}
        ...
        <button
          ...
          className="bg-admin-accent-dark hover:bg-admin-accent px-4 py-2 rounded-md text-white"
        >
          + Create Member
        </button>
            ...
            <button
              ...
              className={`px-3 py-1 rounded-full ${
                filter === role
                  ...
                  : "bg-admin-surface text-gray-300"
              }`}
            >
              {role}
            </button>
