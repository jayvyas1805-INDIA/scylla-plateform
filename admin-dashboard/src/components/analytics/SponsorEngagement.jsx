    ...
    <div className="w-full bg-slate-900 text-white rounded-xl shadow-lg p-6">
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <button
          ...
          className="bg-admin-accent-dark hover:bg-admin-accent-dark px-4 py-2 rounded-lg font-medium"
        >
      ...
      <div className="grid grid-cols-4 text-center gap-6 mb-6">
        ...
        <div>
          <p className="text-2xl font-bold text-admin-accent">{current.clicks}</p>
