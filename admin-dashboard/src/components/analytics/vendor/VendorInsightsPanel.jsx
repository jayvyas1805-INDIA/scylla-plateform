...
export default function VendorInsightsPanel() {
  const insights = [
    {
      ...
      color: "from-admin-accent to-admin-accent-dark",
  ...
  return (
    <div className="bg-gradient-to-br from-admin-bg to-admin-surface-raised border border-gray-800 rounded-xl p-5 text-gray-200">
