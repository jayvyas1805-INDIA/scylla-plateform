...
export default function ControlPanelLayout({ title, children, isSidebarOpen }) {
  ...
  return (
    // Page background now matches the landing page's dark theme
    <div className="min-h-screen bg-admin-bg text-admin-text relative">
      ...
      >
        {title && (
          <h1 className="text-2xl font-semibold text-admin-text mb-6">
            {title}
          </h1>
        )}
        {children}
