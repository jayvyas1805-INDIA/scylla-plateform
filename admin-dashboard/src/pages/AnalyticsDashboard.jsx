    ...
    >
      ...
      >
        ...
        <p className="text-gray-600 text-sm mt-1">
          Workspace: <span className="text-admin-accent">{workspace}</span> | Date Range:{" "}
          <span className="text-admin-accent">{dateRange}</span>
        </p>
      </motion.div>
        ...
        <div className="bg-gray-100 text-gray-900 px-6 py-4 rounded-xl ring-1 ring-gray-300 shadow w-full max-w-2xl">
          <div className="flex items-center justify-between mb-3">
            ...
            <select
              ...
              className="bg-white text-gray-900 rounded-md px-3 py-2 text-sm border border-gray-300 focus:outline-none focus:ring-2 focus:ring-admin-accent"
            >
      ...
      <div className="flex gap-6 border-b border-gray-300">
        {["Team", "Vendor", "Admin"].map((t) => (
          <button
            ...
            onClick={() => setTab(t)}
            className={`pb-2 ${
              tab === t ? "text-admin-accent border-b-2 border-admin-accent-dark" : "text-gray-500"
            }`}
          >
            {t}
          </button>
