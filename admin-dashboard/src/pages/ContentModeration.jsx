...
export default function ContentModeration() {
  ...
  return (
    <div className="min-h-screen bg-admin-bg text-white px-4 sm:px-6 py-4">
      {/* Tabs */}


      <div className="mb-6">
        <h1 className="text-2xl sm:text-3xl font-bold text-admin-accent">
          Content Moderation
        </h1>
      ...
      {activeTab === "media" && (
        <>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {/* Viewer */}
            <div className="lg:col-span-2 bg-admin-surface-raised rounded-xl border border-gray-800 p-6 shadow-md">
...
`}
                ...
                {current?.type === "video" && (
                  <button
                    onClick={togglePlay}
                    className="absolute bottom-4 right-4 bg-admin-accent/20 hover:bg-admin-accent/30 text-admin-accent p-2 rounded-full"
                  >
              ...
              <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-admin-accent/20 text-admin-accent border border-admin-accent/30 hover:bg-admin-accent/30 transition"
                >
            ...
            {/* Details */}
            <div className="bg-admin-surface-raised rounded-xl border border-gray-800 p-6 shadow-md">
              ...
              {current ? (
                <div className="space-y-5 text-sm sm:text-base text-white/80 divide-y divide-gray-800">
                  ...
                  <div className="pt-4">
                    ...
                    <div className="mt-1 text-admin-accent">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 mt-10 mb-6">
            ...
            <select
              ...
              className="px-3 py-2 rounded bg-admin-bg border border-gray-700 text-white"
            >
            ...
            <div className="flex items-center gap-2 ml-auto">
              ...
              <input
                ...
                className="px-3 py-2 rounded bg-admin-bg border border-gray-700 text-white sm:w-64"
              />
            </div>
          </div>
              ...
              {filteredQueue.map((item, index) => (
                <div
                  ...
                  className={`relative w-24 h-24 sm:w-28 sm:h-28 rounded-lg border cursor-pointer overflow-hidden transition transform hover:scale-105 ${selectedMedia === index
                    ? "border-admin-accent shadow-md"
                    : "border-gray-700 hover:border-admin-accent"
                    }`}
                  title={item.title}
                >
                  {item.type === "image" ? (
  ...
  function Modal({ title, children, onClose }) {
    return (
      <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
        <div className="bg-admin-surface-raised border border-gray-700 rounded-xl shadow-xl w-[90%] max-w-lg p-6">
        ...
        <div className="flex flex-col gap-4">
          <div>
            ...
            <input
              ...
              className="w-full mt-1 px-3 py-2 rounded bg-admin-bg border border-gray-700 text-white"
            />
          </div>
          <div>
          ...
          <button
            onClick={handleSave}
            className="mt-4 px-4 py-2 rounded bg-admin-accent text-white hover:bg-admin-accent-dark transition"
          >
            Save Changes
          </button>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 rounded bg-admin-bg border border-gray-700 text-white h-28"
            >
